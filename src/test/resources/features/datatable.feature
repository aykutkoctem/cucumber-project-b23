Feature: Demonstrating the datatable feature of cucumber
  ...
  few know data types support by cucumber
  ...
  Scenario: Representing table with header and more than 2 columns with list of map
    ...
    #since we have multiplerow,we want to store all row map into List of map
